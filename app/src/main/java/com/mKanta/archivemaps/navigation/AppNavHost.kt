...
fun AppNavHost(
    ...
    NavHost(
        ...
        navigation(route = "marker", startDestination = "map/{latitude}/{longitude}") {
            composable("map/{latitude}/{longitude}") { backStackEntry ->
                ...
                val markerViewModel: ListViewModel = viewModel(viewModelStoreOwner = parentEntry)
            ...
            composable("marker_list") { backStackEntry ->
                ...
                val markerViewModel: MapViewModel = viewModel(viewModelStoreOwner = parentEntry)
